	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMFCAppPaintLineView), CSize(100, 100), pContext))
	{
...
CMFCAppPaintLineView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CMFCAppPaintLineView* pView = DYNAMIC_DOWNCAST(CMFCAppPaintLineView, pWnd);
	return pView;
}
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CMFCAppPaintLineView* pView = GetRightPane();
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// 如果右窗格已创建并且是 CMFCAppPaintLineView，
	// 则处理菜单命令...
	if (pView != nullptr)
	{
		DWORD dwStyle = -1;
